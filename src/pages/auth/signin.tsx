        ...
        <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
            ...
            >
                ...
                <div className="p-5 bg-white md:flex-1">
                    ...
                    <form  className="flex flex-col space-y-5" method="post" action="/api/auth/callback/credentials" >
                    <input name="csrfToken" type="hidden" defaultValue={csrfToken} />
                        ...
                        <div>
                            <button
                                ...
                                onClick={async () => signIn("credentials", {
                                    email: email.current, password: password.current, redirect:false
                                }).then(({ok}:any)=>{
                                    if (!ok){
...
export async function getServerSideProps(context: Context) {
    ...
    return {
        props: {
            providers,csrfToken: await getCsrfToken(context),
        },
    }
}